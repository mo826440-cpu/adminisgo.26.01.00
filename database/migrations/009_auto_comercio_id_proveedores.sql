-- ============================================
-- Trigger para asignar automáticamente comercio_id a proveedores
-- ============================================

-- Función trigger para proveedores
CREATE OR REPLACE FUNCTION set_proveedor_comercio_id()
RETURNS TRIGGER AS $$
BEGIN
...
-- Trigger BEFORE INSERT para proveedores
DROP TRIGGER IF EXISTS trigger_set_proveedor_comercio_id ON proveedores;
CREATE TRIGGER trigger_set_proveedor_comercio_id
  BEFORE INSERT ON proveedores
  FOR EACH ROW
  EXECUTE FUNCTION set_proveedor_comercio_id();
