-- ============================================
-- Trigger para asignar automáticamente comercio_id a compras
-- ============================================

-- Función trigger para compras
CREATE OR REPLACE FUNCTION set_compra_comercio_id()
RETURNS TRIGGER AS $$
BEGIN
...
-- Trigger BEFORE INSERT para compras
DROP TRIGGER IF EXISTS trigger_set_compra_comercio_id ON compras;
CREATE TRIGGER trigger_set_compra_comercio_id
  BEFORE INSERT ON compras
  FOR EACH ROW
  EXECUTE FUNCTION set_compra_comercio_id();
